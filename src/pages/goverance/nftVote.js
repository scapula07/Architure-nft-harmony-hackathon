...
import { nftVoteData } from "utils/data";
  ...
  return (
    <div className="w-full md:mt-0 mt-9">
      <div className="bg-[#2D2D2D] rounded-[8px] py-8 px-[22px]">
        ...
        <div>
          <p className="text-white text-[13px] leading-7 mb-4 capitalize font-medium">enter amount to stake</p>
          <div className="flex items-center">
            ...
            <Button
              title="Vote"
              className="w-[180px] font-medium xl:text-base xl:leading-[18px] rounded-[40px] h-10 "
            />
          </div>
