...
const Votes = () => {
  ...
  return (
    <div className='layout-container pb-[166px]'>
      <Hero onClick={() => setShowDetails(true)} className={showDetails ? "hidden" : "flex"} />
      <div className={`pt-5 xl:pt-[68px] ${showDetails ? "block" : "hidden"}`}>
        <h1 className='text-white font-bold text-2xl md:text-3xl lg:text-5xl xl:text-[64px] xl:leading-[74px] mb-1 md:mb-4 xl:mb-[18px]'>Vote</h1>
        <div className='md:grid grid-cols-3 md:items-center xl:items-start gap-x-10 lg:gap-x-20'>
            ...
            <div className='w-full'>
              <div className='bg-[#2D2D2D] rounded-[8px] py-8 px-[22px]'>
                ...
                <div>
                  ...
                  <div className='mt-7'>
                  <h3 className='font-bold text-[#D9D9D9] text-sm uppercase'>Voting stats</h3>
                  <div className='mt-[10px] flex justify-between items-center'>
                    <p className='capitalize text-[#E8EDF0] text-xs'>Total voting power</p>
                    <p className='text-[#E8EDF0] text-xs'>50,976 ONE</p>
                  </div>
                  <div className='mt-[10px] flex justify-between items-center'>
                    <p className='capitalize text-[#E8EDF0] text-xs'>total votes</p>
